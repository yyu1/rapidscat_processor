...
set_plot, 'PS'
device, filename='us_diurnal_backscatter.ps', /landscape
...
hour = indgen(24)
@plot01
PLOT, hour, h_val, title='US East RapidSCAT backscatter Day31-60', xtitle='Hour', ytitle='Backscatter power', psym=4, linestyle=0, yrange=[0.05,0.15]
OPLOT, hour, v_val, psym=5, linestyle=0

;annotation
xyouts, 10, 0.12, 'H Polarization'
xyouts, 10, 0.06, 'V Polarization'

...
set_plot, 'PS'
device, filename='amazon_diurnal_backscatter.ps', /landscape
...
hour = indgen(24)
@plot01
PLOT, hour, h_val, title='Amazon RapidSCAT backscatter Day31-60', xtitle='Hour', ytitle='Backscatter power', psym=4, linestyle=0, yrange=[0.16,0.26]
